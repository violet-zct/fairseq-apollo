...
from fairseq.models.sru.ops import (elementwise_recurrence_inference,
                     elementwise_recurrence_gpu,
                     elementwise_recurrence_naive)

from fairseq.modules import RealNumberEmbedding, SequenceNorm
...
class SRUpp(nn.Module):
    ...
    def __init__(self,
                 ...
                 proj_input_to_hidden_first: bool = False,
                 weight_c_init: float = 1.0,
                 embedding_type: str = "none",  # from here, arguments for LRA encoder
                 padding_idx: int = 0,
                 vocab_size: int = -1,
        ...
        assert embedding_type in ['sparse', 'linear', 'none']
    ...
    def forward(self,
        ...
        if self.embedding_type != 'none':
            ...
            if self.embedding_type == 'sparse':
                padding_mask = input.eq(self.padding_idx)
